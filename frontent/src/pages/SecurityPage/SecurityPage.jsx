...
function SecurityPage() {
	return (
		<>
			<CenteredDiv>
				<TransparentCard>
					<HeaderLarge>Security</HeaderLarge>
					<Text>
					...
					<Text>
						Proin aliquet mauris vel luctus venenatis. Proin finibus
						a nibh eu commodo. Sed in dapibus mauris. Phasellus
						eleifend nec quam nec dignissim. Integer viverra ex
						imperdiet leo feugiat laoreet. Curabitur quis commodo
						dui, id fringilla tortor. Ut sed nunc a massa sodales
						tristique. Nam eget dolor purus. Duis arcu massa,
						volutpat sed condimentum eu, tempor id nibh. Sed sed
						massa pretium, maximus ligula eget, ullamcorper justo.
						Ut metus nunc, pretium et quam id, hendrerit consectetur
						dui. Mauris porttitor, turpis sit amet interdum
						scelerisque, dui est auctor tortor, eu consectetur diam
						enim sed enim. In congue venenatis ultricies.
					</Text>
				</TransparentCard>
			</CenteredDiv>
		</>
